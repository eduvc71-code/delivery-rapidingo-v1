...
// ==================== MODELO PARA ITEMS TEMPORALES DEL CARRITO ====================
...
data class Restaurant(
    ...
    val logoColor: androidx.compose.ui.graphics.Color = androidx.compose.ui.graphics.Color(0xFFD32F2F)
)
...
class MainViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val restaurants = listOf(
        Restaurant(
            ...
            logoColor = androidx.compose.ui.graphics.Color(0xFFFF5722)
        ),
        Restaurant(
            id = "el_brete",
            ...
            logoColor = androidx.compose.ui.graphics.Color(0xFFE91E63)
        ),
        Restaurant(
            id = "la_toscana_1",
            ...
            logoColor = androidx.compose.ui.graphics.Color(0xFF9C27B0)
        ),
        Restaurant(
            id = "la_toscana_2",
            ...
            logoColor = androidx.compose.ui.graphics.Color(0xFF673AB7)
        ),
        Restaurant(
            id = "la_plazuela",
            ...
            logoColor = androidx.compose.ui.graphics.Color(0xFF795548)
        ),
        Restaurant(
            id = "la_coqueta",
            name = "La Coqueta",
        ...
        Restaurant(
            ...
            logoColor = androidx.compose.ui.graphics.Color(0xFF3F51B5)
        ),
        Restaurant(
            id = "toby",
        ...
        Restaurant(
            ...
            logoColor = androidx.compose.ui.graphics.Color(0xFFBA68C8)
        )
    )
    ...
    fun confirmTempOrderAndCreate() {
        ...
        val description = buildString {
            grouped.forEach { (restName, items) ->
                appendLine("🍽️ RESTAURANTE: $restName")
                items.forEach { item ->
                    appendLine("• ${item.productName} x${item.quantity}")
                }
                appendLine()
            }
            appendLine("TOTAL PRODUCTOS: ${tempOrderItems.sumOf { it.quantity }}")
        }
    ...
    // ==================== CÓDIGO ORIGINAL (SIN CAMBIOS ESENCIALES) ====================
